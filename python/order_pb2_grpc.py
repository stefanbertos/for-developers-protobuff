...
class CreateOrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.create = channel.unary_unary(
                '/tutorial.CreateOrderService/create',
...
class CreateOrderServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_CreateOrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'tutorial.CreateOrderService', rpc_method_handlers)
...
class CreateOrderService(object):
    ...
    def create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/tutorial.CreateOrderService/create',
